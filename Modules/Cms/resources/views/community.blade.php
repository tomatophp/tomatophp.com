...
@section('title', (app()->getLocale() === 'en' ? str(setting('site_name'))->explode('|')[0]??setting('site_name') : str(setting('site_name'))->explode('|')[1]??setting('site_name')) . ' | '. trans('cms::messages.community.label'))
@section('description', trans('cms::messages.community.title') . ' ' . trans('cms::messages.community.sub'))
