...
import type { Browser, BrowsingContext, DigitalCredentials, Emulation, Session, UAClientHints } from '../../../protocol/protocol.js';
type DigitalCredentialsBehavior = Omit<DigitalCredentials.SetVirtualWalletBehaviorParameters, 'context'> | null;
/**
