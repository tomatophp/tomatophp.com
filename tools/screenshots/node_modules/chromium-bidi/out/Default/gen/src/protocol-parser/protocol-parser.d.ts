...
export declare namespace BrowsingContext {
    ...
    function parseStartScreencastParams(params: unknown): Protocol.BrowsingContext.StartScreencastParameters;
    function parseStopScreencastParams(params: unknown): Protocol.BrowsingContext.StopScreencastParameters;
...
export declare namespace DigitalCredentials {
    function parseSetVirtualWalletBehaviorParams(params: unknown): Protocol.DigitalCredentials.SetVirtualWalletBehaviorParameters;
}
