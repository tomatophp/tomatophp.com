...
import type { Bluetooth, Browser, BrowsingContext, Cdp, Emulation, Input, Network, Permissions, Script, Session, Storage, WebExtension, UAClientHints, DigitalCredentials } from '../protocol/protocol.js';
export declare class BidiParser implements BidiCommandParameterParser {
    ...
    parseStartScreencastParams(params: unknown): BrowsingContext.StartScreencastParameters;
    parseStopScreencastParams(params: unknown): BrowsingContext.StopScreencastParameters;
    ...
    parseSetVirtualWalletBehaviorParams(params: unknown): DigitalCredentials.SetVirtualWalletBehaviorParameters;
}
