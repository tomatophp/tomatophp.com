            ...
            @forelse ($getOptions() as $value => $label)
                ...
                >
                    ...
                    >
                        ...
                        />
                        @php
                         $package = collect(config('app.packages'))->where('key', $value)->first();
                        @endphp
                            ...
                            >
                                <div class="flex justify-start gap-2">
                                    <div class="flex flex-col justify-center items-center">
                                        <x-icon :name="$package['icon']" class="w-4 h-4" />
                                    </div>
                                    <x-filament::link href="{{ $package['url'] }}" target="_blank">{{ $label }}</x-filament::link>
                                </div>
                            </span>
