<div x-data="{ show: @entangle('shouldDisplayFirstTimeNotice').live }" x-show="show" class="border bg-green-200 dark:border-slate-600 p-4 sm:py-5 sm:px-8 my-4 rounded-lg shadow dark:bg-green-400 dark:text-gray-700">
    ...
    <p class="my-4">
        Welcome to <span class="font-bold">TomatoPHP</span>.<br><br>
        ...
        <span class="font-bold">If you're a maintainer</span> looking to list your project on Find a PR, you can read how to do this in the <a href="https://docs.tomatophp.com" class="underline" target="_blank" rel="noreferrer noopener">documentation</a>.
    </p>
</div>
