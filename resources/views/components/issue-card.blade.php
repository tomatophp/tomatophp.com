...
<div class="p-4 my-4 break-words bg-white border rounded-lg shadow dark:border-slate-600 sm:py-5 sm:px-8 dark:bg-slate-800" wire:loading.class="animate-pulse" x-data="{showMore: false}">
    <div class="flex flex-col items-start justify-start gap-2 sm:flex-row sm:justify-between">
        ...
        <div class="flex">
            <a href="{{ $issue->url }}" target="_blank"
                class="inline-block w-full px-5 py-2 text-sm font-medium text-white transition ease-out bg-primary-400 border border-transparent rounded-md shadow-sm dark:bg-primary-600 hover:bg-primary-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 dark:hover:bg-primary-700">View
                Issue
            </a>
